...
CREATE TABLE "Component" (
	...
	measured_compound_analysis_date TEXT, 
	measured_compound_comment TEXT, 
	measured_compound_derivation_type TEXT, 
	measured_compound_limit_of_quantitation TEXT, 
